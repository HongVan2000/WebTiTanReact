...
class Slider extends React.Component{
    ...
    componentDidMount() {
       ...
       this.topSliderInterval = setInterval(this.nextTopSlider, 5000);
    ...
    render() {
        ...
        return (
         ...
         <div className="slider-actions">
           <button className="btn-previus" onClick={this.backTopSlider}><img src={back}></img></button>
           <span  className="spans"id="slider-paging">1/4</span>
           <button className="btn-next" onClick={this.nextTopSlider}><img src={next}></img></button>
         </div>
       </div>
        )
    } 
